...
// Trust proxy for rate limiting (fixes ERR_ERL_UNEXPECTED_X_FORWARDED_FOR)
...
// Routes
app.use("/v3.0/api/auth", authRoutes);
app.use("/v3.0/api/products", productRoutes);
app.use("/v3.0/api/quotes", quotesRoutes);
app.use("/v3.0/api/docs", documentRoutes);
app.use("/v3.0/api/users", usersRoutes);
app.use("/v3.0/api/clients", clientsRoutes);
app.use("/v3.0/api/email", emailRoutes);
